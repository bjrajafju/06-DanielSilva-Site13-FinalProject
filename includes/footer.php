        ...
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            <a href="" class="text-decoration-none">
                <h1 class="mb-4 display-5 font-weight-semi-bold"><span
                        class="text-primary font-weight-bold border border-white px-3 mr-1">D</span><?= t('footer.brand.name') ?></h1>
            </a>
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <form action="">
                        <div class="form-group">
                            <input type="text" class="form-control border-0 py-4" placeholder="<?= t('footer.newsletter.name_placeholder') ?>"
                                required="required" />
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control border-0 py-4" placeholder="<?= t('footer.newsletter.email_placeholder') ?>"
                                required="required" />
                        </div>
                        <div>
                            <button class="btn btn-primary btn-block border-0 py-3" type="submit"><?= t('footer.newsletter.button') ?></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <div class="row border-top border-light mx-xl-5 py-4">
        <div class="col-md-6 px-xl-0">
            <p class="mb-md-0 text-center text-md-left text-dark">
                &copy; <a class="text-dark font-weight-semi-bold" href="#"><?= t('footer.copyright.site_name') ?></a>. <?= t('footer.copyright.rights') ?>
                <?= t('footer.copyright.designed_by') ?>
                <a class="text-dark font-weight-semi-bold" href="https://htmlcodex.com">HTML Codex</a><br>
                <?= t('footer.copyright.distributed_by') ?> <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
            </p>
        </div>
