...
<div id="content">
    <div class="topbar">
        ...
        <a href="category_form.php" class="btn btn-primary btn-sm"><i class="bi bi-plus-lg"></i> Add New Category</a>
    </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $t_pt['name'] ?? 'N/A' ?></td>
                                    <td class="text-end">
                                        <a href="category_form.php?id=<?= $c['id'] ?>" class="btn btn-sm btn-outline-info"><i class="bi bi-pencil"></i></a>
                                        <a href="category_delete.php?id=<?= $c['id'] ?>" class="btn btn-sm btn-outline-danger btn-delete"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
