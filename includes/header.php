                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="<?= $SETTINGS['url_site'] ?>/index.php" class="nav-item nav-link">Home</a>
                            <a href="<?= $SETTINGS['url_site'] ?>/shop.php" class="nav-item nav-link">Shop</a>
                            <a href="<?= $SETTINGS['url_site'] ?>/detail.php" class="nav-item nav-link active">Shop Detail</a>
                            <div class="nav-item dropdown">
                            ...
                            <a href="<?= $SETTINGS['url_site'] ?>/contact.php" class="nav-item nav-link">Contact</a>
                        </div>
